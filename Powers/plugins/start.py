...
You can donate by contacting my owner: [Sidhu](http://t.me/x_sidhu)
     """
...
async def commands_menu(_, q: CallbackQuery):
    ...
    try:
        cpt = f"""
Hey **[{q.from_user.first_name}](http://t.me/{q.from_user.username})**! I am Shizu✨.
...
async def help_menu(_, m: Message):
    if len(m.text.split()) >= 2:
        ...
        if m.chat.type == ChatType.PRIVATE:
            ...
            keyboard = ikb(ou, True)
            msg = f"""
Hey **[{m.from_user.first_name}](http://t.me/{m.from_user.username})**!I am Shizu✨.
I'm here to help you manage your group(s)!
Commands available:
× /start: Start the bot
× /help: Give's you this message."""
